    ...
    <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionContent className="gap-4 px-8 text-justify">
          <ol className="list-disc py-2">
            <div className="flex flex-col gap-2">
              ...
              <li>
                <span className="font-bold"> Questionários: </span> Seriam úteis
                para coletar informações de um grande número de usuários. Isso
                poderia incluir perguntas sobre suas preferências de design,
                facilidade de uso e funcionalidades desejadas na página de
                cadastro do cupom.
              </li>
              <li>
              ...
              <li>
                ...
                ser útil para obter feedback dos usuários e fazer ajustes antes
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent className="gap-4 px-8 text-justify">
          <p className="">
            ...
            consome aritigos <span className="italic">GEEK.</span> chamado Natan
            com 28 anos. É um grande fã de tudo que é geek. Ele adora
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent className="gap-4 px-8 text-justify">
          <p className="">
            ...
            <span className="font-bold">WIREFRAME</span> veja sua criação com a
            ferramenta {''}
            <Link
      ...
      <AccordionItem value="item-4">
        ...
        <AccordionContent>
          ...
          <Link href={''} target="_blank" className="text-indigo-500 underline">
            Figma
          </Link>
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-5">
        <AccordionTrigger className="font-bold">
          ...
          respeitando às Heurísticas de Nielsen; que são pertinentes ao Projeto.
        </AccordionTrigger>
        <AccordionContent>
          <ol className="list-disc py-2">
            <div className="flex flex-col gap-2">
              ...
              <li>
                ...
                celular/WhatsApp) são termos comuns no mundo real, o que é bom.
                Além disso, a opção para acessar as regras do sorteio ajuda a
              ...
              <li>
                ...
                página tem validações de formulário para prevenir erros, como a
                submissão de um CPF inválido.
              </li>
              <li>
                <span className="font-bold">
              ...
              <li>
                <span className="font-bold">
                  Ajude os usuários a reconhecer, diagnosticar e recuperar-se de
                  erros:
                </span>{' '}
                Se o usuário cometer um erro ao preencher o formulário, a página
                deve informa uma mensagem de erro clara e útil no campo que
                ocorrer o erro.
              </li>
              <li>
                <span className="font-bold">Ajuda e documentação:</span> Embora
                a página é intuitiva de usar, ainda pode haver uma seção de
                ajuda ou FAQ para auxiliar os usuários.
              </li>
            </div>
          </ol>
        </AccordionContent>
